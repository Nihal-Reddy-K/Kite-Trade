        ...
        <div className='container'>
            <div className='row'>
                <div className='col-6 p-5'>
                    ...
                    <p className='text-muted'>With initiatives like Nudge and Kill Switch,we just don't just facilitate transactions, but avctively help you do better with your money.</p>
                </div>
                <div className='col-6 p-5'>
